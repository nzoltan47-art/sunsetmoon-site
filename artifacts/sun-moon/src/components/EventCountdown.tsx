...
export function EventCountdown({ nextEvent }: EventCountdownProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center animate-in fade-in zoom-in duration-700 pointer-events-none">
      ...
      <div className="flex items-baseline space-x-2 sm:space-x-4">
        <div className="flex flex-col items-center">
          ...
          <span className="text-xs sm:text-sm text-white/50 uppercase tracking-widest mt-2">
            Hours
          </span>
        </div>
        <span className="text-4xl sm:text-6xl lg:text-7xl text-white/30 font-light mb-8">
          :
        </span>
        <div className="flex flex-col items-center">
          <span className="text-5xl sm:text-7xl lg:text-8xl font-display font-bold text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] tabular-nums">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-xs sm:text-sm text-primary/50 uppercase tracking-widest mt-2">
            Secs
          </span>
        </div>
      </div>
